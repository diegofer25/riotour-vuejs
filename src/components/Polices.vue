<template>
  <div id="polices" class="container white-text">
    ...
    <div class="polices text-justify">
      <p>
        SEÇÃO 1 - O QUE FAREMOS COM ESTA INFORMAÇÃO? <br>
      ...
      <p>
        SEÇÃO 2 - CONSENTIMENTO <br>
        Como vocês obtêm meu consentimento? <br>
        ...
        Se após você nos fornecer seus dados, você mudar de ideia, você pode retirar o seu consentimento para que possamos entrar em contato, para a coleção de dados contínua, uso ou divulgação de suas informações, a qualquer momento, entrando em contato conosco em diego.lamarao92@gmail.com ou nos enviando uma correspondência em: Lamarão Softwares rua pinto teles 354, BLOCO 2 APT 308
      </p>
      <p>
        SEÇÃO 3 - DIVULGAÇÃO <br>
        Podemos divulgar suas informações pessoais caso sejamos obrigados pela lei para fazê-lo ou se você violar nossos Termos de Serviço.
      </p>
      <p>
        SEÇÃO 4 - SERVIÇOS DE TERCEIROS <br>
      ...
      <p>
        SEÇÃO 6 - ALTERAÇÕES PARA ESSA POLÍTICA DE PRIVACIDADE <br>
