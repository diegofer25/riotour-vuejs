<template>
  <div id="polices" class="container white-text">
    <div class="row center">
      <img  width="210px" src="../assets/riotour-logo.png" />
      <h3>Rio Tour</h3>
    </div>
    <div class="polices text-justify">
      <h4>TERMOS DE SERVIÇO</h4>
        <p>
          VISÃO GERAL <br>
          Esse site é operado pelo Lamarão Softwares. Em todo o site, os termos “nós”, “nos” e “nosso” se referem ao Lamarão Softwares. O Lamarão Softwares proporciona esse site, incluindo todas as informações, ferramentas e serviços disponíveis deste site para você, o usuário, com a condição da sua aceitação de todos os termos, condições, políticas e avisos declarados aqui.
          ...
          SEÇÃO 1 - TERMOS DA LOJA VIRTUAL <br>
        ...
        <p>
          SEÇÃO 3 - PRECISÃO, INTEGRIDADE E ATUALIZAÇÃO DAS INFORMAÇÕES <br>
        ...
        <p>
          SEÇÃO 4 - MODIFICAÇÕES DO SERVIÇO E PREÇOS <br>
        ...
        <p>
          SEÇÃO 5 - PRODUTOS OU SERVIÇOS (caso aplicável) <br>
        ...
        <p>
          SEÇÃO 6 - PRECISÃO DE INFORMAÇÕES DE FATURAMENTO E CONTA <br>
        ...
        <p>
          SEÇÃO 7 - FERRAMENTAS OPCIONAIS <br>
        ...
        <p>
          SEÇÃO 9 - COMENTÁRIOS, FEEDBACK, ETC. DO USUÁRIO <br>
        ...
        <p>
          SEÇÃO 10 - INFORMAÇÕES PESSOAIS <br>
        ...
        <p>
          SEÇÃO 11 - ERROS, IMPRECISÕES E OMISSÕES <br>
        ...
        <p>
          SEÇÃO 13 - ISENÇÃO DE RESPONSABILIDADE DE GARANTIAS; LIMITAÇÃO DE RESPONSABILIDADE <br>
        ...
        <p>
          SEÇÃO 18 - LEGISLAÇÃO APLICÁVEL <br>
          Esses Termos de serviço e quaisquer acordos separados em que nós lhe fornecemos os Serviços devem ser regidos e interpretados de acordo com as leis de rua pinto teles 354, BLOCO 2 APT 308, Rio de Janeiro, RJ, 21341270, Brazil.
        </p>
        <p>
          SEÇÃO 19 - ALTERAÇÕES DOS TERMOS DE SERVIÇO <br>
        ...
        <p>
          SEÇÃO 20 - INFORMAÇÕES DE CONTATO <br>
          As perguntas sobre os Termos de serviço devem ser enviadas para nós através do diego.lamarao92@gmail.com.
        </p>
      <div class="row">
        <button class="btn hoverable" @click="back()">VOLTAR</button>
      </div>
    </div>
  </div>
</template>
